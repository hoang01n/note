...
export const SearchBar = ({value,onChange,handleSearch,onCleacrSearch}) => {
  return (
    <div className='w-80 flex items-center px-4 bg-slate-200 rounded-md'>
        ...
        {value && (
        <IoIosClose className=' text-slate-400 text-2xl cursor-pointer hover:text-black mr-3 '  onClick={onCleacrSearch}/>    )}
